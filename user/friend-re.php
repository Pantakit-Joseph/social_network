...
`user_id` IN (SELECT `friends`.`friend_id` FROM `friends` WHERE `friends`.`user_id`='$user_id' AND `friends`.`accept`='0')
...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-8"> 
                <h3><i class="fas fa-users"></i> ยังไม่ได้ตอบรับเป็นเพื่อน</h3> 
